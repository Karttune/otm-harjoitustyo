...
public class PcrprimerdesignApplication extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        grid.add(new Label("Warnings:"), 12, 2);
        grid.add(matchingNucleotidesCheck, 12, 3);
        grid.add(gcCheck, 12, 4);
        grid.add(tmCheck, 12, 5);
        grid.add(repeatCheck, 12, 6);
        grid.add(gcClampCheck, 12, 7);
        grid.add(dinucleotideCheck, 12, 8);
        grid.add(palindromicCheck, 12, 9);
        grid.add(primerDimerCheck, 12, 10);
        grid.add(fwdThreePrimeMatchCheck, 12, 11);
